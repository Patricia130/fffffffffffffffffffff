...
-keep public class com.seentechs.newtaxiuser.appcommon.helper.** {
     public protected *;
}

-keep class com.seentechs.newtaxiuser.taxiapp.views.firebaseChat.FirebaseChatModelClass{ *; }

-keep class com.seentechs.newtaxiuser.taxiapp.views.main.MainActivity{ *; }
-keep class com.seentechs.newtaxiuser.appcommon.datamodels.**{ *; }
-keep class com.seentechs.newtaxiuser.taxiapp.datamodels.**{ *; }
-keep class com.seentechs.newtaxiuser.appcommon.map.**{ *; }

-keep class com.seentechs.newtaxiuser.taxiapp.views.voip.NewTaxiSinchService{ *; }
#}
