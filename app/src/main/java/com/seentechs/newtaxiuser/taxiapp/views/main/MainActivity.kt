package com.seentechs.newtaxiuser.taxiapp.views.main
...
import com.seentechs.newtaxiuser.appcommon.custompalette.CustomTypefaceSpan
import com.seentechs.newtaxiuser.appcommon.database.SqLiteDb
import com.seentechs.newtaxiuser.appcommon.datamodels.JsonResponse
import com.seentechs.newtaxiuser.appcommon.drawpolyline.DirectionsJSONParser
import com.seentechs.newtaxiuser.appcommon.helper.Constants
import com.seentechs.newtaxiuser.appcommon.helper.Constants.Req_TYPE_NORMAL
import com.seentechs.newtaxiuser.appcommon.helper.Constants.Req_TYPE_POOL
import com.seentechs.newtaxiuser.appcommon.helper.Constants.scheduledDuration
import com.seentechs.newtaxiuser.appcommon.helper.LatLngInterpolator
import com.seentechs.newtaxiuser.appcommon.helper.Permission
import com.seentechs.newtaxiuser.appcommon.interfaces.ApiService
import com.seentechs.newtaxiuser.appcommon.interfaces.ServiceListener
import com.seentechs.newtaxiuser.appcommon.map.AppUtils
import com.seentechs.newtaxiuser.appcommon.network.AppController
import com.seentechs.newtaxiuser.appcommon.network.PermissionCamer
import com.seentechs.newtaxiuser.appcommon.placesearch.InfoWindowData
import com.seentechs.newtaxiuser.appcommon.pushnotification.Config
import com.seentechs.newtaxiuser.appcommon.pushnotification.NotificationUtils
import com.seentechs.newtaxiuser.appcommon.utils.CommonKeys
import com.seentechs.newtaxiuser.appcommon.utils.CommonMethods
import com.seentechs.newtaxiuser.appcommon.utils.CommonMethods.Companion.DebuggableLogD
import com.seentechs.newtaxiuser.appcommon.utils.CommonMethods.Companion.DebuggableLogE
import com.seentechs.newtaxiuser.appcommon.utils.CommonMethods.Companion.DebuggableLogI
import com.seentechs.newtaxiuser.appcommon.utils.CommonMethods.Companion.DebuggableLogV
import com.seentechs.newtaxiuser.appcommon.utils.CommonMethods.Companion.startChatActivityFrom
import com.seentechs.newtaxiuser.appcommon.utils.CommonMethods.Companion.startSinchService
import com.seentechs.newtaxiuser.appcommon.utils.Enums.REG_GET_PAYMENTMETHOD
import com.seentechs.newtaxiuser.appcommon.utils.Enums.REQ_COMMON_DATA
import com.seentechs.newtaxiuser.appcommon.utils.Enums.REQ_GET_DRIVER
import com.seentechs.newtaxiuser.appcommon.utils.Enums.REQ_GET_RIDER_PROFILE
import com.seentechs.newtaxiuser.appcommon.utils.Enums.REQ_NEAREST_CARS
import com.seentechs.newtaxiuser.appcommon.utils.Enums.REQ_SEARCH_CARS
import com.seentechs.newtaxiuser.appcommon.utils.Enums.REQ_SEND_REQUEST
import com.seentechs.newtaxiuser.appcommon.utils.Enums.REQ_TRIP_DETAIL
import com.seentechs.newtaxiuser.appcommon.utils.Enums.REQ_UPDATE_LOCATION
import com.seentechs.newtaxiuser.appcommon.utils.RequestCallback
import com.seentechs.newtaxiuser.appcommon.utils.RuntimePermissionDialogFragment
import com.seentechs.newtaxiuser.appcommon.views.BannerActivityCommon
import com.seentechs.newtaxiuser.appcommon.views.CommonActivity
import com.seentechs.newtaxiuser.appcommon.views.SupportActivityCommon
...
import com.seentechs.newtaxiuser.taxiapp.adapters.SeatsListAdapter
import com.seentechs.newtaxiuser.taxiapp.database.AddFirebaseDatabase
import com.seentechs.newtaxiuser.taxiapp.datamodels.DriverLocation
import com.seentechs.newtaxiuser.taxiapp.datamodels.PaymentMethodsModel
import com.seentechs.newtaxiuser.taxiapp.datamodels.RiderProfile
import com.seentechs.newtaxiuser.taxiapp.datamodels.StepsClass
import com.seentechs.newtaxiuser.taxiapp.datamodels.main.NearByCarsModel
import com.seentechs.newtaxiuser.taxiapp.datamodels.main.NearestCar
import com.seentechs.newtaxiuser.taxiapp.datamodels.trip.Riders
import com.seentechs.newtaxiuser.taxiapp.datamodels.trip.TripDetailsModel
import com.seentechs.newtaxiuser.taxiapp.firebase_keys.FirebaseDbKeys
import com.seentechs.newtaxiuser.taxiapp.firebase_keys.FirebaseDbKeys.LIVE_TRACKING_NODE
import com.seentechs.newtaxiuser.taxiapp.firebase_keys.FirebaseDbKeys.TRIP_PAYMENT_NODE
...
import com.seentechs.newtaxiuser.taxiapp.sidebar.payment.AddWalletActivity
import com.seentechs.newtaxiuser.taxiapp.sidebar.payment.PaymentPage
...
import com.seentechs.newtaxiuser.taxiapp.singledateandtimepicker.SingleDateAndTimePicker
import com.seentechs.newtaxiuser.taxiapp.views.customize.CustomDialog
...
import com.seentechs.newtaxiuser.taxiapp.views.main.filter.FeatureSelectListener
import com.seentechs.newtaxiuser.taxiapp.views.main.filter.FeaturesInCarModel
...
import com.seentechs.newtaxiuser.taxiapp.views.splash.SplashActivity.Companion.checkVersionModel
